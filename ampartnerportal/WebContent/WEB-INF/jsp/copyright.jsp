...
<body>
    <div id="main_container">
        <div id="header">
            ...
            <div id="main_nav">
                <ul class="menu">
                    <li style="text-align:left; padding:0 4px; font-weight:bold; color:#999; line-height:3.0em; width:200px"><a><str:label strId="AMPARTNERPORTAL" key="footer_disclaimer"/></a></li>
                </ul>
            </div>
        ...
        <c:set var="targetURL"><str:label strId="AMPARTNERPORTAL" key="footer_link_copyright"/></c:set>
