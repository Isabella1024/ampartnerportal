      ...
      <div class="main_content">
		...
		<div class="offer_box_complete">
            <div class="detail_log statusdiv">
                    <span class="offerErrorMsg"><str:label strId="AMPARTNERPORTAL" key="instant_redeem_error_title" /><str:label strId="AMPARTNERPORTAL" key="instant_redeem_expired_offer" /></span>
                      <p><str:label strId="AMPARTNERPORTAL" key="instant_redeem_expired_offer_msg" /></p>
                </div>
              <!-- /redeem item   start-->
            <div class="detail_log offerErrorImg">
                  <img id="statusimages" src="<%=request.getContextPath()%>/images/instantRedeem/merchant/offer-expired.png">
              </div>
