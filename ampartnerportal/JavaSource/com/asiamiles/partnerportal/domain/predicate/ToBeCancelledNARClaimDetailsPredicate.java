...
/**
 * Predicate for identifying NAR Claims Details with was cancelled.
 * It is to be used in conjunction with CollectionUtils' methods
 * @author CPPBENL
 * @see org.apache.commons.collections.CollectionUtils
 */
public class ToBeCancelledNARClaimDetailsPredicate implements Predicate {
	...
	public boolean evaluate(Object obj) {
		...
		return (claim.isToBeProcessed() && NARClaimDetails.ACTION_CANCEL.equals(claim.getAction()));
	}
