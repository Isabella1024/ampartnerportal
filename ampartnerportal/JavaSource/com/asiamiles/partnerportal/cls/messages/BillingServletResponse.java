 ...
 *
 */
public class BillingServletResponse extends CLSResponse {
	...
	public static BillingServletResponse decodeFromXML(String xml) {
		XStream xstream = new XStream(new XppDomDriver());
		xstream.alias("PaperlessPartnerInvoiceServlet", BillingServletResponse.class);
		xstream.alias("claim", BillingServletResponse.NARDetails.class);
		xstream.addImplicitCollection(BillingServletResponse.class, "NARDetails");
		Object obj = xstream.fromXML(xml);
		return (BillingServletResponse)obj;
	}
