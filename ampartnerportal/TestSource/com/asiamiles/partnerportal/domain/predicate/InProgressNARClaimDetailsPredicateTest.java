/**
 * Unit Tests for <code>InProgressNARClaimDetailsPredicate</code>.
 * 
 * @author CPPKENW
 * @see com.asiamiles.partnerportal.domain.predicate.InProgressNARClaimDetailsPredicate
 * 
 */
...
public class InProgressNARClaimDetailsPredicateTest extends TestCase {
	...
	public void testEvaluate() {
		...
		CollectionUtils.select(narList, new InProgressNARClaimDetailsPredicate(), claims);
