...
public class ClaimNoNARClaimDetailsPredicateTest extends TestCase {
	...
	public void testEvaluate() {
		...
		claims.addAll(CollectionUtils.select(narList, new ClaimNoNARClaimDetailsPredicate(new String("12"))));
