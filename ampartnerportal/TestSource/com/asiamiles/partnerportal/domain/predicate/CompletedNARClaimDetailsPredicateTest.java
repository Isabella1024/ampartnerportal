/**
 * Unit Tests for <code>CompletedNARClaimDetailsPredicate</code>.
 * 
 * @author CPPKENW
 * @see com.asiamiles.partnerportal.domain.predicate.CompletedNARClaimDetailsPredicate
 * 
 */
...
public class CompletedNARClaimDetailsPredicateTest extends TestCase {
	...
	public void testEvaluate() {
		...
		CollectionUtils.select(narList, new CompletedNARClaimDetailsPredicate(), claims);
